...
export const doctors: Member[] = [
  ...
  { name: "Pallavi V", qualifications: "BNYS, MD (Yoga)", bio: "Dr. Pallavi V is an accomplished academician and healthcare professional with a BNYS and MD in Yoga. She currently serves as an Assistant Professor at S.S.Y.N.M., where she is actively involved in teaching, mentoring students, and contributing to academic development. In addition to her academic responsibilities, she oversees SEC-G (Department of Gastroenterology), supporting departmental coordination and promoting integrative approaches to gastrointestinal health and wellness. Dr. Pallavi also brings valuable clinical experience, having served as a Medical Officer at MSR Arogyalayam, Vijayawada, from April 2021 to July 2022. During this tenure, she was actively involved in patient care, applying naturopathy and yogic principles in clinical practice. With a strong foundation in naturopathy and yogic sciences, she is committed to holistic healing, evidence-based practice, research, and guiding students in both academic and clinical domains." },
