export interface Member {
  ...
  bio?: string;
  ledBy?: boolean;
  role?: string; // section role label (e.g. "Yoga Therapist") shown in the bio modal
}
...
export const doctors: Member[] = [
  ...
  { name: "Aishwarya Sahu", qualifications: "BPT, MPT" },
...
export const yogaTherapists: Member[] = [
  ...
  { name: "Surajit Kar", qualifications: "BSc, MSc" },
